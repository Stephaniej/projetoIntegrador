...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
            ...
            <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('css/contato.css')); ?>">
      ...
      <div id="body-contato">
        ...
        <div class="container">
          <div class="row d-flex justify-content-between">
            ...
            <img src="<?php echo e(asset('imgs/imagens_cortadas/phone.png')); ?>" width="25%" height="27%">
           ...
           <div class="col-md-5" id="bloco2">
            <img src="<?php echo e(asset('imgs/imagens_cortadas/mail.png')); ?>" width="25%" height="27%">
        ...
        <div id="midias">
          ...
          <div id="img-link">
            <ul>
              <li>
                <a href=""><img src="<?php echo e(asset('imgs/imagens_cortadas/logoface.png')); ?>" width="74"></a>  
              </li>
              <li class="padding-top">
                <a href=""><img src="<?php echo e(asset('imgs/imagens_cortadas/logotw.png')); ?>" width="87"></a>  
              </li>
              <li class="padding-top2">
                <a href=""><img src="<?php echo e(asset('imgs/imagens_cortadas/logoin.png')); ?>" width="74"></a>  
              </li>
              <li class="padding-top2">
                <a href=""><img src="<?php echo e(asset('imgs/imagens_cortadas/logoit.png')); ?>" width="75"></a>  
              </li>
            </ul> 
          </div>
        </div>
...
</html><?php /**PATH /Applications/MAMP/htdocs/projetoIntegrador/torabitecommerce/resources/views/contato.blade.php ENDPATH**/ ?>