...
<html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="<?php echo e(asset('css/carr.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('css/docs.theme.min.css')); ?>">
    ...
    <body>
        ...
        <section id="conteudo">
            ...
            <section id="area-carrossel">
                ...
                <?php echo $__env->make('carrossel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/projetoIntegrador/torabitecommerce/resources/views/index.blade.php ENDPATH**/ ?>