       ...
       <?php if(auth()->guard()->guest()): ?>
          ...
          <li class="nav-item">
            <a href="" class="nav-link">
             <img src="<?php echo e(asset('imgs/imagens_cortadas/carrinho.png')); ?>" width="30">    
            </a>
          </li>
        </ul>
...
</nav> --><?php /**PATH /Applications/MAMP/htdocs/projetoIntegrador/torabitecommerce/resources/views/header.blade.php ENDPATH**/ ?>