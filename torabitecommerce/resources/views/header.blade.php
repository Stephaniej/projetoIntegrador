...
<header>
    <nav class="navbar navbar-expand-sm">
      ...
      <div class="collapse navbar-collapse" id="nav-target2">
       ...
       <ul class="navbar-nav">
          <li class="nav-item link"><a href="cadastro.blade.php" class="nav-link">Cadastre-se</a></li>
     
          <li class="nav-item link"><a href="form.blade.php" class="nav-link">Login</a></li>
